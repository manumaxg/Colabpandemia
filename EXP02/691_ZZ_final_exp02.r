...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910-exp02"
PARAM$exp_input  <- "HT6510-exp02"
...
PARAM$semillas  <- c( 355537, 357755, 775733, 337753, 575533, 158771, 616523, 742499, 217981, 235439 ) #reemplazar por las propias semillas
